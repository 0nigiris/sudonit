...
export const home: Record<Locale, Record<HomeKey, string>> = {
  ru: {
    ...
    'who.body': 'Родом из Москвы, последние года четыре живу в Аликанте и учусь в школе. Говорю на трёх языках: по-русски — свободно, по-английски и по-испански — почти свободно (с каждым месяцем «почти» всё короче). Технику люблю с детства — даже не вспомню, с чего началось. Просто всю жизнь ремонтирую всё и всем. И честно сразу: мне 15 и я только начинаю — большого опыта пока нет. Поэтому и цены честные, и денег не беру, пока не сделаю работу.',
    'who.portraitAlt': 'Александр за работой',
    'why.eyebrow': 'Почему',
    'why.quote': 'Мне нравится понимать, как всё устроено. И не выбрасываю вещь, пока не попробую её отремонтировать.',
    'why.body': 'Учусь на практике. Отдельный кайф — копаться в Linux (кажется, я там уже всё изучил, но всегда находится ещё). Зачем мне всё это? Честно — всё сразу: деньги, опыт, мечта и просто потому, что нравится. А ещё хочу своё дело — пока не решил какое, но точно своё.',
    'life.eyebrow': 'Вне техники',
    'life.body': 'В свободное время рисую (только начал), смотрю аниме и слушаю музыку — от классики до чего угодно. Я меломан без жанра: понравилось — сохранил. А ещё веду YouTube-канал — пока пустой, но скоро будут гайды, полезные штуки и просто мои мысли. Канал свободный, без рамок.',
  ...
  en: {
    ...
    'life.body': "When I'm not buried in hardware, I draw (just getting started), watch anime, and listen to a lot of music — from classical to anything. I'm a genre-less music lover: if I like it, I save it. I also run a YouTube channel — empty for now, but soon it'll have guides, useful bits, and just my thoughts. A free channel, no rules.",
  ...
  es: {
    ...
    'life.body': 'Cuando no estoy metido en el hardware, dibujo (acabo de empezar), veo anime y escucho mucha música — de la clásica a lo que sea. Soy melómano sin género: si me gusta, lo guardo. También tengo un canal de YouTube — vacío por ahora, pero pronto habrá guías, cosas útiles y simplemente mis ideas. Un canal libre, sin reglas.',
