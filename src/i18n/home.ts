...
export const home: Record<Locale, Record<HomeKey, string>> = {
  ru: {
    ...
    'life.body': 'В свободное время рисую (только начал), смотрю аниме и слушаю музыку. Я меломан без жанра: понравилось — сохранил. А ещё веду YouTube-канал — пока пустой, но скоро будут гайды, полезные штуки и просто мои мысли. Канал свободный, без рамок.',
